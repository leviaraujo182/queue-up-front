...
export default function Dashboard() {
  return (
    <div className="w-full h-full p-5 gap-5 flex flex-col">
          ...
          <CardHeader className="gap-0">
            <div className="flex justify-between">
              <div>
                ...
                <CardDescription>Gerencie os clientes na fila</CardDescription>
              </div>
              <div>
          ...
          <Card className="flex-1">
            <CardHeader>
              ...
              <CardContent className="p-0 flex flex-col gap-1">
                ...
                <div>
                  <div className="text-gray-700">Horário de funcionamento</div>
